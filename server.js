...
app.get('/', isAuthenticated, (req, res) => {
  ...
  const activities = [
    { id: 1, title: 'Animal Name Challenge', image: '/img/actividad1.webp' },
    { id: 2, title: 'Animal Body Parts', image: '/img/actividad2.jpg' },
    { id: 3, title: 'Guess Who I am', image: '/img/actividad3.jpg' },
    { id: 4, title: 'Dog Features Quiz', image: '/img/actividad4.webp' },
    { id: 5, title: 'Animal Bingo!', image: '/img/actividad5.webp' },
  ];
